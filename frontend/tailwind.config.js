...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'grid-pattern': 'linear-gradient(to right, theme(colors.dark.800/50) 1px, transparent 1px), linear-gradient(to bottom, theme(colors.dark.800/50) 1px, transparent 1px)',
